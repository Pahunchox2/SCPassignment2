...
<html lang="en">
  ...
  <body class="container">
    <h1>Use form below to create a record in our Kenworth Trucks database</h1>
    ...
    <form method="post" action="connection.php" class="form-group">
        ...
        <br><br>
        <label>Enter SCP Desciption</label>
        <br>
        <input type="text" name="description" placeholder="SCP Description" class="form-control">
        <br><br>
        <label>Enter SCP Containment</label>
        <br>
        <input type="text" name="containment" placeholder="SCP Containment" class="form-control">
        <br><br>
